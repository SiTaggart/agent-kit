...
| Eval 1 or 2 fails Stage 1 | Synthesis loss is severe — distinctive coined terms are being dropped. | Investigate the session-historian synthesis persona (`../references/session-historian.md`); consider tightening it to preserve verbatim terminology. Revise PR #838's claims accordingly. |
