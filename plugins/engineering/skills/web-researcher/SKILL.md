---
name: web-researcher
description: Perform iterative web research and return structured external grounding. Use when planning or ideating needs prior art, competitor patterns, cross-domain analogies, or market signals from outside the repo. Prefer over ad hoc manual web searches for structured external context.
---
