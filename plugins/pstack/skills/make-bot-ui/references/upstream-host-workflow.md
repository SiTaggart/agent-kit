# Upstream host workflow — historical source only

Do not execute these Cursor/Grok instructions in Codex. Read [the ported skill](../SKILL.md) and pass its native runtime preflight. Source: `cursor/plugins` commit `93b00b89ef425a9c1bac0d0b317dfc49c930ac99`, `pstack/skills/make-bot-ui/SKILL.md`. The original file follows verbatim.
