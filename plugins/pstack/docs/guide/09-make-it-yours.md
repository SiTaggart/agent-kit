...
You don't describe your style, because [`$automate-me`](../../skills/automate-me/SKILL.md) reads it out of your history. It mines your recent transcripts in the active workspace for repeated preferences, in how you like replies, delegation, verification, code, prose, and process, then asks you which patterns are really you. It drafts a project-local `<your-name>-mode/SKILL.md` under the host’s skills directory through the selected host’s skill-authoring workflow, runs the draft through [`$unslop`](../../skills/unslop/SKILL.md), and opens a PR from a worktree so you review it like any other change.
