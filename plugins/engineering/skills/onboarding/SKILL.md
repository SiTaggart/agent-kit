...
After writing, inform the user that `ONBOARDING.md` has been generated. Offer next steps using the platform's blocking question tool (see `../ce-conventions/SKILL.md`).
