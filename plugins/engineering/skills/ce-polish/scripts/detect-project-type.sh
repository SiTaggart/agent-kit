...
#
# Supported root types: next, vite, nuxt, astro, remix, sveltekit, procfile
#
# Monorepo probe:
...
#
# `multiple` is reserved for genuine disambiguation cases (e.g., Next + Vite).
