...
test("all 53 skills have one owner and relative skill references stay inside that plugin", async () => {
  const owners = new Map<string, string>();
  for (const [id, count] of [["engineering", 31], ["git", 11], ["knowledge", 11]] as const) {
