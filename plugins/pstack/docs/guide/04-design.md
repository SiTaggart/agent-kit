...
If implementation is already authorized, it proceeds from the synthesized design into that work. A design-only request stops at the design. To request a checkpoint explicitly, say so:
